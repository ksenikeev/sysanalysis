...
public class TSPRestController {
    ...
    private static final String publikKeyStr = "";
    ...
    public void index(HttpServletResponse response) {
        ...
        try {
            ...
            byte[] indexFile = getClass().getResourceAsStream("/index.html").readAllBytes();
            pw.write(indexFile);
        } catch (IOException e) {
            e.printStackTrace();
        }
